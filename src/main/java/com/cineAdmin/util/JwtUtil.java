...
public class JwtUtil {
    ...
    private String secret = "CineView";
    ...
    private ResponseEntity<TokenResponse> createToken(Map<String, Object> claims, String subject) {
         ...
         tr.setBearerToken(token);
         tr.setMessage("success");
         tr.setUserId(subject);
